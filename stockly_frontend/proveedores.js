...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!proveedoresList || !modal || !btnAgregar || !btnGuardar || !btnCancelar) {
    console.error('Uno o más elementos del DOM no se encontraron. Verifique los IDs y clases en el HTML.');
    return;
  }
  ...
  async function cargarProveedores() {
    try {
      const res = await fetch('../crud_Productos/obtener_proveedores.php');
